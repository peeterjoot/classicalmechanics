...
% ****************************************************************************************************
\newcommand{\myTitle}{Classical Mechanics\xspace}
\newcommand{\mySubtitle}{Independent study and phy354 notes and problems\xspace}
\newcommand{\myDegree}{}
...
%----------------------
   %\newcommand{\myTime}{Aug 2012}
   \input{./.revinfo/gitCommitDateAsMyTime.tex}
%----------------------
%\newcommand{\myVersion}{version v.2\xspace}
% v.1 changelog: http://wp.me/ppf39-Nz
% next version if posted:
% https://sites.google.com/site/peeterjoot2/math2013/classicalmechanics.pdf?revision=2
...
\hypersetup{%
    ...
    pdfsubject={Advanced Classical Mechanics},%
    pdfkeywords={Classical Mechanics} {PHY354H1F} {University of Toronto},%
    pdfcreator={pdfLaTeX},%
