...
%\href{https://www.physicsforums.com/showthread.php?p=1853416}{PF thread.}
\href{https://www.physicsforums.com/threads/metric-tensor-question.252596/}{PF thread.}
%
...
%
\begin{equation}\label{eqn:lorentzMetricTensor:20}
e^i \cdot e_j = {\delta^i}_j.
\end{equation}
%
So, if a vector is specified in terms of the \(e_i\)
\begin{equation}\label{eqn:lorentzMetricTensor:40}
x = \sum e_j a_j.
\end{equation}
%
Dotting with \(e^i\) one has:
%
\begin{equation}\label{eqn:lorentzMetricTensor:60}
...
%
\begin{equation}\label{eqn:lorentzMetricTensor:80}
x = \sum e_j x^j = e_j x^j.
\end{equation}
%
Now, if one calculates dot product here, say with \(x\), and a second vector
%
\begin{equation}\label{eqn:lorentzMetricTensor:100}
y = \sum e_j y^j.
\end{equation}
%
you have:
%
\begin{equation}\label{eqn:lorentzMetricTensor:120}
...
tensor form:
%
\begin{equation}\label{eqn:lorentzMetricTensor:140}
