...
%
\begin{dmath}\label{eqn:InfinitePlanePotentialTakeIII:70}
...
%
\begin{dmath}\label{eqn:InfinitePlanePotentialTakeIII:90}
\phi (z, \epsilon )
=
...
%
\begin{dmath}\label{eqn:InfinitePlanePotentialTakeIII:90b}
\phi (z, \epsilon )
=
2 \pi  G \sigma  \Biggl(
