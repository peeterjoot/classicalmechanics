...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:760}
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:780}
...
and for \( k = 2 \) we have
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:800}
\begin{aligned}
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:840}
\begin{aligned}
   K_1
   &= \inv{2} m_1
\dot{\Theta}^\T
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:860}
K_2 = \inv{2} m_2
\dot{\Theta}^\T
B_2 B_2^\T
\dot{\Theta}
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:880}
K =
\inv{2}
\dot{\Theta}^\T
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:900}
\mu_k \equiv \sum_{j=k}^2 m_j,
\end{equation}
%
so
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:920}
K =
\inv{2}
\dot{\Theta}^\T
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:940}
K =
\inv{2}
\dot{\Theta}^\T Q
\dot{\Theta},
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:960}
Q_{ij} =
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:980}
T_1 = m_1 g l_1 \cos\theta_1,
\end{equation}
%
and the potential energy for mass 2 is
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:1000}
T_2 = m_2 g \lr{
l_1 \cos\theta_1 +
l_2 \cos\theta_2
}.
...
%
\begin{equation}\label{eqn:multiPendulumSphericalMatrix:1020}
\begin{aligned}
T
...
\begin{aligned}
0
&= \grad_{\BTheta} \Lq - \frac{d}{dt} \left(\grad_{\dot{\BTheta}} \Lq \right) \\
&=
\sum_k
{\begin{bmatrix}
\begin{bmatrix}
