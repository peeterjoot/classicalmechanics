...
\begin{proof}
Setting \( F = 1 \) in \cref{eqn:unpackingFundamentalTheorem:680}, we have
\begin{equation}\label{eqn:unpackingFundamentalTheorem:700}
\int J du dv I \rgrad G = \ointclockwise d\Bx G,
\end{equation}
and need only multiply on the left with \( I^{-1} \) to find \( \int dx^1 dx^2 \rgrad G = \ointclockwise I^{-1} d\Bx G \).  In terms of a parameterization \( x = x(u,v) \), the pseudoscalar for the space is
...
For the \( G = 1 \) case we have
\begin{equation}\label{eqn:unpackingFundamentalTheorem:820}
\int J du dv F I \lgrad = \ointclockwise F d\Bx.
\end{equation}
In a 2D space, regardless of metric, we have \( I a = - a I \) for any vector \( a \) (i.e. \( \grad \) or \( d\Bx\)), so multiplication by \( -I^{-1} \) gives
\begin{dmath}\label{eqn:unpackingFundamentalTheorem:840}
\int J du dv F \lgrad
=
-\ointclockwise F d\Bx I^{-1}
=
\ointclockwise F I^{-1} d\Bx,
\end{dmath}
as claimed.
...
\imageFigure{../figures/classicalmechanics/gradientOutWardsNormalFig1}{Outwards normal along boundary.}{fig:gradientOutWardsNormal:gradientOutWardsNormalFig1}{0.3}
\item Spacetime:
...
\imageFigure{../figures/classicalmechanics/gradientOutWardsNormalSpaceTimeFig1}{Boundary normal orientation for a spacetime basis.}{fig:gradientOutWardsNormalSpaceTime:gradientOutWardsNormalSpaceTimeFig1}{0.3}
\item Spacelike:
...
\imageFigure{../figures/classicalmechanics/gradientOutWardsNormalSpacelikeDiracFig1}{Boundary orientation for a Dirac spacelike basis.}{fig:gradientOutWardsNormalSpacelikeDirac:gradientOutWardsNormalSpacelikeDiracFig1}{0.3}
\end{itemize}
