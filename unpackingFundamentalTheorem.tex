...
\end{equation}
Geometrically, this has the area of the parallelogram spanned by \( d\Bx_u \) and \( d\Bx_v \), but weighted by the pseudoscalar of the space.  This is explored algebraically in \cref{problem:unpackingFundamentalTheorem:11} and illustrated in 
FIXME.
%\cref{fig:areaElementParallelograph:areaElementParallelographFig1}.
...
This is sketched in 
FIXME.
%\cref{fig:lineIntegralAroundRectangle:lineIntegralAroundRectangleFig1}.
...
\end{equation}
This pair of integrals is plotted in 
FIXME
%\cref{fig:GreensTheoremBoundary:GreensTheoremBoundaryFig1}
...
\end{equation}
Each of the terms in the integrand above are illustrated in 
FIXME
%\cref{fig:gradientOutWardsNormal:gradientOutWardsNormalFig1}
, and we see that this is a path integral weighted by the outwards normal.
...
\end{aligned}
\end{equation}
With \( t \) plotted along the horizontal axis, and \( x \) along the vertical, each of the terms of this integrand is illustrated graphically in 
%\cref{fig:gradientOutWardsNormalSpaceTime:gradientOutWardsNormalSpaceTimeFig1}
FIXME
.  For this mixed signature space, there is no longer any good geometrical characterization of the normal.
