...
\Lq = \inv{2} m \left( \dot{r}^2 + r^2 \thetadot^2 \right) - \inv{2} m \omega_0^2 r^2 - m g r( 1 - \cos\theta).
\end{equation}
%
...
\begin{aligned}
P_\theta &= \PD{\thetadot}{\Lq} = m r^2 \thetadot \\
P_r &= \PD{\rdot}{\Lq} = m \rdot \\
\ddt{P_\theta} &= \PD{\theta}{\Lq} = -m g r \sin\theta \\
\ddt{P_r} &= \PD{r}{\Lq} = m r \thetadot^2 - m \omega_0^2 r - m g (1 - \cos\theta).
\end{aligned}
\end{equation}
%
Or
