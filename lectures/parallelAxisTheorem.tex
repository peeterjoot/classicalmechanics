...
%
\begin{equation}\label{eqn:parallelAxisTheorem:10}
T = \inv{2} \sum_{i, j = 1}^3 \Omega_i I_{i j} \Omega_j,
\end{equation}
%
where
%
\begin{equation}\label{eqn:parallelAxisTheorem:30}
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:50}
m = \int d^3 \Br \rho(\Br),
\end{equation}
%
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:70}
I_{i j}
...
We write
%
\begin{equation}\label{eqn:parallelAxisTheorem:90}
\Br_a = \Br_a' + \Bb,
\end{equation}
%
and \(I_{i j}'\) for the inertia tensor with respect to \(O'\).  Write
%
\begin{equation}\label{eqn:parallelAxisTheorem:110}
\Br_{a_i} = \Br_{a_i}' + \Bb_i,
\end{equation}
%
or
%
\begin{equation}\label{eqn:parallelAxisTheorem:130}
\Br_{a_i}' = \Br_{a_i} - \Bb_i,
\end{equation}
%
so that
%
\begin{equation}\label{eqn:parallelAxisTheorem:150}
\begin{aligned}
I_{i j}'
&=
\sum_a m_a \left(
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:170}
\sum_a m_a r_{a_i}' = 0,
\end{equation}
%
so
%
\begin{equation}\label{eqn:parallelAxisTheorem:190}
\begin{aligned}
I_{i j}'
&=
\sum_a m_a \left(
...
This is
%
\begin{equation}\label{eqn:parallelAxisTheorem:210}
I_{i j}'
= I_{i j}^{\mathrm{CM}}
+ \mu \left( \delta_{i j} \Bb^2 - b_i b_j \right).
\end{equation}
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:290}
\begin{aligned}
T
...
\end{equation}
%
\begin{equation}\label{eqn:parallelAxisTheorem:310}
V_{\mathrm{CM}} = \frac{\Delta x}{\Delta t} = R \frac{\Delta \phi}{\Delta t} = R \Omega = R \phidot,
\end{equation}
%
so
%
\begin{equation}\label{eqn:parallelAxisTheorem:330}
...
Write
%
\begin{equation}\label{eqn:parallelAxisTheorem:350}
\Br = \Ba + \Br',
\end{equation}
%
and
%
\begin{equation}\label{eqn:parallelAxisTheorem:371}
\Bv
= \BV_{\mathrm{CM}}
+ \BOmega \cross \Br,
\end{equation}
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:390}
V_{\mathrm{CM}} = \BOmega \cross \Bb = \phidot \zcap \cross \Bb,
\end{equation}
%
where this followed from
%
\begin{equation}\label{eqn:parallelAxisTheorem:410}
\Bv = \BOmega \cross \Br'.
\end{equation}
%
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:430}
...
%
\begin{equation}\label{eqn:parallelAxisTheorem:450}
\BV_{\mathrm{CM}} = \BOmega \cross \Bb.
\end{equation}
%
\begin{equation}\label{eqn:parallelAxisTheorem:470}
\begin{aligned}
\Abs{\BV_{\mathrm{CM}}}
&= \Abs{\phidot} \Abs{\Bb} \\
...
For
%
\begin{equation}\label{eqn:parallelAxisTheorem:490}
\begin{aligned}
T
&= \frac{\mu}{2} \phidot^2
\left(
...
and
%
\begin{equation}\label{eqn:parallelAxisTheorem:510}
\Lq = T - \mu g
\mathLabelBox{
( R - a \cos\phi )
