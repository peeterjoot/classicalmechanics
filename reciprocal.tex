...
We saw that \cref{thm:reciprocal:1500} also depended on a non-zero square for the \( \Bx_1 \wedge \Bx_2 \) bivector.  If a bivector can be factored into a pair of orthogonal vectors, but one of those is lightlike, then the bivector will square to zero.
