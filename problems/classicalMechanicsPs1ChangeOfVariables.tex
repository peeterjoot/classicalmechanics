...
%
Consider a Lagrangian \(\Lq({q},{\qdot}) \equiv \Lq(q_1,\cdots, q_N, \qdot_1,\cdots \qdot_N)\). Now change the coordinates to some
...
\tilde{\Lq}({x},{\xdot}) = \Lq(q_1({x}),\cdots q_N({x}),\ddt{} q_1({x}),\cdots \ddt{} q_N({x})),
\end{equation}
%
which is now a function of \(x_i\) and \(\xdot_i\). Show that the Euler-Lagrange equations for \(\Lq({q},{\qdot})\):
%
\begin{equation}\label{eqn:classicalMechanicsPs1:500}
\frac{\partial \Lq({q},{\qdot})}{\partial q_i} =
\ddt{}
\frac{\partial \Lq({q},{\qdot})}{\partial \qdot_i},
\end{equation}
%
imply that the Euler-Lagrange equations for \(\tilde{\Lq}({x},{\xdot})\) hold (provided the change of variables \(q \rightarrow x\) is nonsingular):
\begin{equation}\label{eqn:classicalMechanicsPs1:520}
\frac{\partial \tilde{\Lq}({x},{\xdot})}{\partial x_i} =
\ddt{}
\frac{\partial \tilde{\Lq}({x},{\xdot})}{\partial \xdot_i}.
\end{equation}
%
...
\PD{q_i}{\Lq} =
\PD{r_j}{\Lq} \PD{q_i}{r_j}
+\PD{\rdot_j}{\Lq} \PD{q_i}{\rdot_j}.
\end{equation}
%
...
\PD{\qdot_i}{\Lq}
=
\PD{r_j}{\Lq} \PD{\qdot_i}{r_j}
+\PD{\rdot_j}{\Lq} \PD{\qdot_i}{\rdot_j}
=
\PD{r_j}{\Lq} \PD{\qdot_i}{r_j}
+\PD{\rdot_j}{\Lq} \PD{q_i}{r_j},
\end{equation}
%
...
&=
  \PD{r_j}{\Lq} \PD{q_i}{r_j}
+ \cancel{\PD{\rdot_j}{\Lq} \PD{q_i}{\rdot_j}}
- \left( \ddt{} \PD{\rdot_j}{\Lq} \right) \PD{q_i}{r_j}
- \cancel{\PD{\rdot_j}{\Lq} \ddt{} \PD{q_i}{r_j} }
\\
&=
\left( \PD{r_j}{\Lq}
-\ddt{} \PD{\rdot_j}{\Lq}
