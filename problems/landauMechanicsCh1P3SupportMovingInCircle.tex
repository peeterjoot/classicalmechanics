...
%
\begin{equation}\label{eqn:landauMechanicsCh1P3:10}
p = a e^{i \gamma t} + i l e^{i\phi},
\end{equation}
%
or in coordinates
%
\begin{equation}\label{eqn:landauMechanicsCh1P3:30}
p = (a \cos\gamma t + l \sin\phi, -a \sin\gamma t + l \cos\phi).
\end{equation}
%
The velocity is
%
\begin{equation}\label{eqn:landauMechanicsCh1P3:50}
\pdot = (-a \gamma \sin\gamma t + l \phidot \cos\phi, -a \gamma \cos\gamma t - l \phidot \sin\phi),
\end{equation}
%
and in the square
\begin{equation}\label{eqn:landauMechanicsCh1P3:70}
\begin{aligned}
\pdot^2
...
%
\begin{equation}\label{eqn:landauMechanicsCh1P3:90}
...
%
\begin{equation}\label{eqn:landauMechanicsCh1P3:110}
U = - m g l \cos\phi,
\end{equation}
%
so by the above the Lagrangian should be (after also dropping the constant term \(m a^2 \gamma^2/2\)
\begin{equation}\label{eqn:landauMechanicsCh1P3:130}
\Lq =
...
\begin{equation}\label{eqn:landauMechanicsCh1P3:150}
\Lq =
