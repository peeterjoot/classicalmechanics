...
\begin{itemize}
   ...
   \item Derivation of Maxwell's equation (in it's STA form) from the Maxwell Lagrangian,
...
\begin{dmath}\label{eqn:maxwells:2020}
   F^2
   = \lr{ \BE + I c \BB }^2
...
\begin{dmath}\label{eqn:maxwells:2040}
0
= \gamma_\nu \lr{ \PD{A_\nu}{} - \partial_\mu \PD{(\partial_\mu A_\nu)}{} } \LL
...
\begin{dmath}\label{eqn:maxwells:2060}
   \gpgrade{ X F }{0,4} = \inv{2} \lr{ X F + F X },
\end{dmath}
for any two bivectors \( X, F \).  This leaves
\begin{dmath}\label{eqn:maxwells:2080}
   0
...
\begin{dmath}\label{eqn:maxwells:2100}
