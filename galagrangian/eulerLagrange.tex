...
\frac{d\Lq}{d\alpha}
=
\PD{q^i}{\Lq} \PD{\alpha}{q^i}
+\PD{\qdot^i}{\Lq} \PD{\alpha}{\qdot^i}.
\end{equation}
%
...
\frac{d\Lq}{d\alpha}
=
\left(\frac{d}{d\lambda} \PD{\qdot^i}{\Lq}\right)
\PD{\alpha}{q^i}
+\PD{\qdot^i}{\Lq} \PD{\alpha}{\qdot^i}.
\end{equation}
%
...
\frac{d\Lq}{d\alpha} = \frac{d}{d\lambda} \left( \PD{\qdot^i}{\Lq} \PD{\alpha}{q^i} \right).
\end{equation}
%
...
\left.\frac{d\Lq}{d\alpha}\right\vert_{\alpha = \alpha_0} = \frac{d}{d\lambda} \left( \PD{\qdot^i}{\Lq} \left.\PD{\alpha}{q^i}\right\vert_{\alpha = \alpha_0} \right).
\end{equation}
%
%
...
\frac{d\Lq}{d\lambda} = \frac{d}{d\lambda} \left( \PD{\qdot^i}{\Lq} \PD{\lambda}{q^i} \right).
\end{equation}
%
...
would require an additional \(\PDi{\lambda}{\Lq}\) term.
...
\frac{dH}{d\lambda} = \frac{d}{d\lambda} \left( \PD{\qdot^i}{\Lq} \qdot^i - \frac{d\Lq}{d\lambda} \right) = 0 .
\end{equation}
%
Up to a constant
\begin{equation}\label{eqn:eulerLagrange:242}
H = \PD{\qdot^i}{\Lq} \qdot^i - \frac{d\Lq}{d\lambda},
\end{equation}
%
...
\Lq(q, \qdot, \lambda) &\rightarrow \Lq' = \Lq(q', \qdot', \lambda) = \Lq(f, \fdot, \lambda).
\end{aligned}
\end{equation}
%
...
\DD{\alpha}{\Lq'}
= \frac{d}{d\lambda} \left( \PD{\fdot}{\Lq} \PD{\alpha}{f} \right) .
\end{equation}
%
This is
\begin{equation}\label{eqn:eulerLagrange:382}
\DD{\alpha}{\Lq'}
= \frac{d}{d\lambda} \left( \PD{\qdot'}{\Lq} \PD{\alpha}{q'} \right).
\end{equation}
%
...
\sum_i \PD{{\dot{q'}^i}}{\Lq} \PD{\alpha}{{q^i}'} = \text{constant}.
\end{equation}
%
...
\left.\DD{\alpha}{\Lq'}\right\vert_{\alpha=0}
= \frac{d}{dt} \sum_{i=1}^n \left(
\PD{\alpha}{X_i'} \conj \partial_{\Xdot_i}{\Lq}
\right) .
\end{equation}
%
...
\Delta \Lq =
(\overbar{\Bq} + \Bn) \cdot \left.\grad_\Bq \Lq \right\vert_{\Bq = \overbar{\Bq}}
+ (\dot{\overbar{\Bq}} + \dot{\Bn}) \cdot \left.\grad_{\dot{\Bq}} \Lq \right\vert_{\dot{\Bq} = \dot{\overbar{\Bq}}}.
\end{equation}
%
...
\grad_{\Bq} \Lq = \frac{d}{d\lambda} \grad_{\dot{\Bq}} \Lq.
\end{equation}
%
...
\Lq = \inv{2}m \dot{\Bx}^2 - \phi(\Abs{\Bx}^k).
\end{equation}
%
...
\PD{\theta}{\Lq'}
= \frac{d}{dt} \left( \PD{\theta}{\Bx'} \cdot \spacegrad_{\Bv'}{\Lq} \right).
\end{equation}
%
...
\Lq = K - \phi = \inv{2} \sum_{ij} g_{ij} \qdot^i \qdot^j - \phi,
\end{equation}
%
...
\begin{aligned}
\PD{\qdot^i}{\Lq} &= m \sum_{j} g_{ij} \qdot^j - \PD{\qdot^i}{\phi} \\
\implies \\
\sum_i \qdot^i \PD{\qdot^i}{\Lq}
...
\Lq = \inv{2}m v \cdot v + q A \cdot v/c.
\end{equation}
%
We therefore have
%
...
\begin{aligned}
x &= x(\lambda) \\
\Lq &= \inv{2}m \frac{dx}{d\lambda} \cdot \frac{dx}{d\lambda} + q A \cdot \frac{dx}{d\lambda}/c \\
\PD{\lambda}{\Lq} &= \frac{d}{d\lambda} \PD{\lambda}{\Lq}.
\end{aligned}
\end{equation}
%
...
\Lq(q^i, \qdot^i, \lambda) &\rightarrow \Lq' = \Lq({q^i}', {\dot{q'}^i}, \lambda) = \Lq(f^i, \fdot^i, \lambda).
\end{aligned}
\end{equation}
%
Now as before consider the derivative
...
\DD{\alpha}{\Lq'} = \sum_i \PD{f^i}{\Lq} \PD{\alpha}{f^i} + \PD{\fdot^i}{\Lq} \PD{\alpha}{\fdot^i}.
\end{equation}
%
In terms of the transformed coordinates the Euler-Lagrange equations require
%
\begin{equation}\label{eqn:eulerLagrange:1062}
\PD{f^i}{\Lq} = \frac{d}{d\lambda} \PD{\fdot^i}{\Lq}.
\end{equation}
%
and backsubstitution into \eqnref{eqn:euler_lagrange:gnoethtmp1} gives
\begin{equation}\label{eqn:euler_lagrange:gnoethtmp2}
\DD{\alpha}{\Lq'} = \sum_i \frac{d}{d\lambda} \left( \PD{\fdot^i}{\Lq} \right) \PD{\alpha}{f^i} + \PD{\fdot^i}{\Lq} \PD{\alpha}{\fdot^i}.
\end{equation}
%
This can be written as a total derivative if
...
\DD{\alpha}{\Lq'}
= \frac{d}{d\lambda} \left( \sum_i \PD{\fdot^i}{\Lq} \PD{\alpha}{f^i} \right) .
\end{equation}
%
QED.
