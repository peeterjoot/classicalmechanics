...
%
\subsection{Deriving the field Lagrangian equations.}
%
...
\end{equation}
%
\subsubsection{First order Taylor expansion of a multi variable function.}
%
...
\end{equation}
%
\subsubsection{First order expansion of the Lagrangian function.}
%
...
\end{equation}
%
\subsubsection{Example for clarification.}
...
\end{equation}
%
\subsubsection{Calculation of the action for the general field Lagrangian.}
%
...
%
\subsection{Verifying the equations.}
\subsubsection{Maxwell's equation derivation from action.}
%
