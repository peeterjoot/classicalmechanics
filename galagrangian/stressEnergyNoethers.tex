...
%
The energy momentum tensor has been computed for some general field Lagrangians.  Now let's consider some specific concrete examples.
The Lagrangian for the relativistic wave equation is an
...
&=
\inv{2} \partial_t
\lr{ \dotphi^2 + \phi_x^2 + \phi_y^2 + \phi_z^2 }
...
&=
\inv{2} \lr{ \dotphi^2 + (\spacegrad \phi)^2 }
.
\end{aligned}
\end{equation}
%
