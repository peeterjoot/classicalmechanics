...
&\quad+ \omega^2 \left( a (R_2 \sin\alpha - R_1 \sin\theta) - R_1 R_2 \cos(\alpha - \theta) \right).
\end{aligned}
\end{equation}
%
The last part of the problem was to show that there is an additional conserved quantity when \(a=0\).  The Lagrangian in that case is:
%
