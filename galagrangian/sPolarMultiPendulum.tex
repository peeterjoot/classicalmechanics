...
%
\begin{subequations}
\label{eqn:sPolarMultiPendulum:zoo3a}
...
\dot{\zcap} 
= \left( -j \thetadot e^{-j\theta} - \frac{dj}{dt} \sin\theta \right) \Be_3 
=
\left(
\frac{d}{dt}
\begin{bmatrix}
...
%
\begin{dmath}\label{eqn:sPolarMultiPendulum:zoo18}
\phi' 
= g \sum m_i h_i
% two:
...
\begin{aligned}
&- \theta_a' \theta_b' 
\lr{ j_a e^{-j_a \theta_a} j_b e^{j_b\theta_b} + j_b e^{-j_b \theta_b} j_a e^{j_a\theta_a} }
- \sin\theta_a \sin\theta_b (j_a' j_b' + j_b' j_a') \\
&\quad - \sin\theta_b \theta_a' ( j_a e^{-j_a \theta_a} j_b' + j_b' j_a e^{j_a \theta_a} )
