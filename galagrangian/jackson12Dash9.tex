...
\spacegrad \Lq = \frac{d}{dt} \spacegrad_\Bu \Lq = \left( \frac{\partial}{\partial t} + \Bu \cdot \spacegrad \right) \Be_a \frac{\partial \Lq}{\partial \xdot^a}.
\end{equation}
%
...
\begin{aligned}
\Be_a \frac{\partial \Lq}{\partial \xdot^a}
&=
...
\Be_a \frac{\partial \Lq}{\partial x^a} = e\left( \inv{c}\xdot^b \spacegrad A^b - \spacegrad \phi \right).
\end{equation}
%
