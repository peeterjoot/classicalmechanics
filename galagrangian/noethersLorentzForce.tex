...
\end{equation}
%
The dot product of two such transformed vectors is
...
\PD{\alpha}{\Lq'} = \frac{d}{d\tau} \left( \PD{\alpha}{x'} \cdot \grad_{v'} \Lq \right).
\end{equation}
%
...
%
Or
\begin{equation}\label{eqn:noethers_lorentz_force:noethersLxTx}
\begin{aligned}
x \wedge \pdot
