...
\makedefinition{Pseudoscalar.}{dfn:lorentzForceCovariant:n}{
The pseudoscalar for the space is denoted \( I = \gamma_0 \gamma_1 \gamma_2 \gamma_3 \).
} % definition
\makeproblem{Pseudoscalar square.}{problem:lorentzForceCovariant:99}{
Show that \( I \) defined by \cref{dfn:lorentzForceCovariant:17} satisfies
\begin{equation*}
\tilde{I} = I,
\end{equation*}
where the tilde (\(~\)) represents reversion.
and
\begin{equation*}
I^2 = -1.
\end{equation*}
...
\makedefinition{Spatial basis.}{dfn:lorentzForceCovariant:n}{
