...
\begin{equation*}
\frac{dp}{d\tau} = q F \cdot v,
\end{equation*}
where \( p = m v \) is the proper momentum, and \( F \) is the Faraday bivector \( F = \grad \wedge A \).
} % theorem
\begin{proof}
...
= q \lr{ \grad (A \cdot v) - \frac{d}{d\tau} \lr{ \grad_v (A \cdot v)} }
= q \lr{ \grad (A \cdot v) - \frac{dA}{d\tau} }.
\end{dmath}
...
\delta L
=
-\frac{dp}{d\tau} + q\lr{ \grad (A \cdot v) -  (v \cdot \grad) A }
=
-\frac{dp}{d\tau} + q \lr{ \grad \wedge A } \cdot v.
\end{dmath}
\end{proof}
