...
Here I'll cover the derivation from the relativistic Lagrangian and some associated concepts, including a lighting review of geometric algebra in its STA (Space Time Algebra) form.
...
\end{dmath}
\end{proof}
Observe that raising or lowering the index of a coordinate toggles the sign, if that index is spatial:
