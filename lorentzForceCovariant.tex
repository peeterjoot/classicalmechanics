...
Note that some of the prerequisite ideas and auxillary details are presented as problems with solutions.  The reader should attempt all such problems themselves.
\section{Conventions.}
...
\makedefinition{Reciprocal frame.}{dfn:lorentzForceCovariant:19}{
   It will be useful to define a reciprocal basis defined by \( \gamma^\alpha \cdot \gamma_\beta = {\delta^\alpha}_\beta \).
} % definition
