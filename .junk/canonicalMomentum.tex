...
%
\begin{equation}\label{eqn:canonicalMomentum:80}
\PD{\xdot^{\mu}}{\LL}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:canonicalMomentum:100}
...
%
\begin{equation}\label{eqn:canonicalMomentum:120}
\PD{\xdot^{\mu}}{\LL} = \gamma_{\mu} \cdot p.
\end{equation}
%
In terms of our reciprocal frame vectors, the components of \(p\) are:
%
\begin{equation}\label{eqn:canonicalMomentum:140}
p = \gamma_{\mu} \gamma^{\mu} \cdot p = \gamma_{\mu} p^{\mu},
\end{equation}
\begin{equation}\label{eqn:canonicalMomentum:160}
...
\begin{aligned}
   \frac{d p}{d\tau} &= \grad \LL - \ddtau{} \grad_v \LL
p &= \grad_v \LL \\
...
%
\begin{equation}\label{eqn:canonicalMomentum:180}
